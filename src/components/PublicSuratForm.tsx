        ...
        {reference ? (
          ...
          <form onSubmit={submit} className="space-y-5 p-4 sm:p-6">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <label className="text-xs font-bold text-slate-700 sm:col-span-2">Keterangan tambahan <span className="font-normal text-slate-400">(opsional)</span><textarea rows={2} maxLength={500} value={form.keteranganLain} onChange={e => update('keteranganLain', e.target.value)} className={`${inputClass} mt-1 resize-y`} /></label>
            </div>
